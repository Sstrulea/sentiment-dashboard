...
2. Never use these words in a summary point: hawkish, dovish, bullish, bearish, "paves the way" (nor paved the way, paving the way). The words likely, expects, signals, suggests (nor signal, signalled, signaled, signalling, signaling, suggest, suggested, suggesting) are allowed only when the document itself uses that same word and you attribute it to the bank, for example "The Committee expects inflation to return to 2 percent" or "The Board says inflation is likely to remain high" - never in your own voice.

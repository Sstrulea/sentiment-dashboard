...
- **Verificarea (obligatorie, înainte de scriere).** Citat: verbatim în paragraful pe care îl numește (modelul declară paragraful; offset-ul absolut îl derivă
  ...
  aceeași propoziție („The Committee expects …”, „Waller expects real GDP to grow”), niciodată în vocea rezumatului. **Atribuire prin oglindirea sursei** (adăugată după prima rulare pe main): cuvântul moale e atribuit corect și când subiectul din punct e chiar subiectul propoziției-sursă care conține același cuvânt („The staff expected …” față de „the staff’s forecast … higher than previously expected”; „GDP growth of around 1% is expected”; „companies were expecting …”). Subiectul = cuvintele dintre ultimul separator din punct (virgulă, `; : — –`, that / while / and / as / because …) și cuvântul moale; **toate** cuvintele lui de conținut și o formă a cuvântului trebuie să apară într-o **aceeași clauză** a paragrafelor citate de punct (propoziție tăiată la `; : — – --`; virgula nu taie). Un subiect inventat, unul luat din altă clauză sau altă propoziție, un pronume sau un paragraf necitat rămân refuzate (`mirrors_the_source`; 7 cazuri reale în `tests/fixtures/cb/attribution_cases.json`). Limită asumată: un punct în „vocea proprie” al cărui subiect + cuvânt coincid cu ale sursei trece; verificarea că *documentul* spune acel lucru rămâne cea de grounding. Motivul: comunicatele reale spun „likely”, „expects”, „suggests”
